...
return static function (
    ...
    $services->set(Environment::class)
        ->arg('$loader', new DependencyInjection\Reference(Loader\LoaderInterface::class))
        ->call(
            'addExtension',
            [new DependencyInjection\Reference(Twig\Extension\ProjectBuilderExtension::class)]
        )
    ;
};
