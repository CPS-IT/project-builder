...
final class FilesystemHelper
{
    ...
    {
        $installPath = InstalledVersions::getInstallPath('cpsit/project-builder');

        if (null !== $installPath) {
            $installPath = Filesystem\Path::canonicalize($installPath);
        }

        return $installPath ?? dirname(__DIR__, 2);
    }
}
